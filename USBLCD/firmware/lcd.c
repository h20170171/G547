...
void lcd_putc(char c)
{
    ...
    else
    {
      ...
      lcd_waitbusy();   // read busy-flag and address counter
        ...
        }else if ( pos == LCD_START_LINE2+LCD_DISP_LENGTH+1 ){
            lcd_write((1<<LCD_DDRAM)+LCD_START_LINE1,0);
        }
#elif LCD_LINES==4
    
        if ( pos == LCD_START_LINE1+LCD_DISP_LENGTH-1) {
            cmd =(1<<LCD_DDRAM)+LCD_START_LINE2;    
        }else if ( pos == LCD_START_LINE2+LCD_DISP_LENGTH-1) {
            cmd =(1<<LCD_DDRAM)+LCD_START_LINE3;
        }else if ( pos == LCD_START_LINE3+LCD_DISP_LENGTH-1 ) {
            cmd =(1<<LCD_DDRAM)+LCD_START_LINE4;
        }else if ( pos == LCD_START_LINE4+LCD_DISP_LENGTH-1 ) {
            cmd =(1<<LCD_DDRAM)+LCD_START_LINE1;
        }
...
Returns:  none
*************************************************************************/
//void lcd_putsl(const char *s,char len)
/* //print string on lcd (no auto linefeed) 
{
   while ( len--) {
        lcd_putc(s++);
